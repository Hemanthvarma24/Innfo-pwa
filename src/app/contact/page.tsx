  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-gray-600 mb-8">Get in touch with us for any queries or assistance</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Card className="hover:shadow-md transition-shadow feature-card">
                <CardContent className="p-6 flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-600 mb-4 text-sm">Chat with us instantly</p>
                  <a
                    href="https://wa.me/919876543210"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-green-600 hover:text-green-700 font-medium btn-animate inline-block px-4 py-2 rounded-md bg-green-100"
                  >
                    Chat Now
                  </a>
                </CardContent>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <a href="mailto:info@innfopg.com" className="text-gray-600 hover:text-primary">
                        info@innfopg.com
                      </a>
                    </div>
                  </div>
              ...
              <CardContent>
                <div className="flex items-center space-x-4">
                  <div className="w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center">
                    <span className="text-xl font-bold text-gray-600">RK</span>
                  </div>
                  <div>
                    <h3 className="font-medium">Rajesh Kumar</h3>
                    <p className="text-gray-600 ">PG Owner & Manager</p>
                    <p className="text-sm text-gray-500 ">15+ years experience in hospitality</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div>
            {isSubmitted ? (
              ...
              >
                ...
                <p className="text-green-700 mb-4">We'll get back to you within 24 hours.</p>
